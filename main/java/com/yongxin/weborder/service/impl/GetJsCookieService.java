...
//            wc.setCredentialsProvider(creds);
    ...
    public static void main(String[] args) {
        GetJsCookieService service = new GetJsCookieService();
        String url = service.getCookieUrl("61.144.43.42","8008");
